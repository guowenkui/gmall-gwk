...
public class AttrGroupServiceImpl extends ServiceImpl<AttrGroupDao, AttrGroupEntity> implements AttrGroupService {
    ...
    @Override
    public PageVo queryGroupPage(QueryCondition condition, Long catId) {

        QueryWrapper<AttrGroupEntity> objectQueryWrapper = new QueryWrapper<>();
        if (catId!=null){
            objectQueryWrapper.eq("catelog_id",catId);
        }
        IPage<AttrGroupEntity> page = this.page(
    ...
    public List<GroupVO> queryGroupWithAttrsByCid(Long cid) {
        ...
        return attrGroupEntities.stream().map(attrGroupEntity -> this.queryGroupWithAttrByGid(attrGroupEntity.getAttrGroupId())).collect(Collectors.toList());
    }
