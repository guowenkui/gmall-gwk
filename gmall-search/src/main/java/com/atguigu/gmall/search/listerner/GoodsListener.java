package com.atguigu.gmall.search.listerner;
    ...
    public void listener(Long spuId){
        ...
        if (!CollectionUtils.isEmpty(skuInfoEntities)){
            ...
            List<Goods> goodsList = skuInfoEntities.stream().map(skuInfoEntity -> {
                ...
                //查询库存信息
                Resp<List<WareSkuEntity>> wareSkuistResp = this.wmsClient.queryWareSkuBySkuId(skuInfoEntity.getSkuId());
                List<WareSkuEntity> wareSkuEntities = wareSkuistResp.getData();
